/**
 * Inheritance real-world scenario: Payment systems
 * Inheritance usage: Payment class defines common behavior, while subclasses implement specific logic.
 * Extensibility: Adding new payment methods (e.g., CryptoPayment) is easy without changing existing code.
 */

package com.minte9.oop.inheritance.examples;
